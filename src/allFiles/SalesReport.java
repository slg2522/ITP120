...
{
	//method does not handle the exception from the getTotalSales(), so write IOException
   ...
   */
   ...
   public static String getFileName()
   {
      ...
      //current file location to enter: C:\Users\sabri\Desktop\NOVA\ITP120\Textbook Source Code\Chapter 05\MonthlySales.txt
 ...
 //method does not handle the exception, so write IOException
